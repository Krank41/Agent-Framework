...
class WeaviateMemstore():
    def __init__(
        ...
        if use_embedded:
            print("Connecting to weaviate embedded client")
            ...
            print(f"Connecting to weaviate instance at {os.getenv('WEAVIATE_URL')}")
            try:
                self.client = weaviate.Client(
                ...
                print(f"Error starting client: {err}")
                raise err
    ...
    def add_data_obj(self, data_class: str, data_obj: dict) -> str:
        ...
        if data_class in self.data_class_names:
            ...
            print(f"Data class {data_class} not found")
    ...
    def get_data_obj(self, task_id: str, data_class: str, query: str) -> list:
        try:
            ...
            print(f"{data_class} schema was not found {err}")
            raise
